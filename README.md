...
-Thinking in React means looking at a Web UI or App UI and breaking it down into components and subcomponents to modularize the UI for reusability and versatility.

- [x] Describe state.

-state is the current state of data being handled by the app component that changes with data changes, user imput/interactivity.

- [x] Describe props.

-Props are parameters and properties passed around as rules/attributes for how your state should render
